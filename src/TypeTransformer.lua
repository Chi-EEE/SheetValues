...
return {
	...
	["vector3"] = function(v)
		...
		return Vector3.new(tonumber(comps[1]) or 0, tonumber(comps[2]) or 0, tonumber(comps[3]) or 0)
	end,
	["vector2"] = function(v)
		local comps = string.split(v, ",")
		return Vector2.new(tonumber(comps[1]) or 0, tonumber(comps[2]) or 0)
	end,
	["udim2"] = function(v)
		local comps = string.split(v, ",")
		return UDim2.new(
	...
	["udim"] = function(v)
		local comps = string.split(v, ",")
		return UDim.new(tonumber(comps[1]) or 0, tonumber(comps[2]) or 0)
	end,
	["color3"] = function(v)
		local comps = string.split(v, ",")
		return Color3.new(tonumber(comps[1]) or 0, tonumber(comps[2]) or 0, tonumber(comps[3]) or 0)
	end,
	...
	["rgb"] = function(v)
		local comps = string.split(v, ",")
		return Color3.fromRGB(tonumber(comps[1]) or 0, tonumber(comps[2]) or 0, tonumber(comps[3]) or 0)
	end,
	["cframe"] = function(v)
		local comps = string.split(v, ",")
		return CFrame.new(tonumber(comps[1]) or 0, tonumber(comps[2]) or 0, tonumber(comps[3]) or 0)
	end,
	["enum"] = function(v)
		local comps = string.split(v, ".")
